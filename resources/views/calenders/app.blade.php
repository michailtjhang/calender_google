...
<head>
    ...
    <title>{{ $title ?? 'Calendar Events' }}</title>

    <!-- Fonts -->
    <link rel="dns-prefetch" href="//fonts.bunny.net">
    <link href="https://fonts.bunny.net/css?family=Inter:400,500,600,700" rel="stylesheet">

    <!-- DaisyUI 4.x + Tailwind CSS -->
...
<body class="bg-base-200 min-h-screen">
                        ...
                        <div tabindex="0" role="button" class="btn btn-ghost btn-circle avatar">
                            <div class="w-10 rounded-full">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-full h-full p-2">
    ...
    <script>
        function showToast(message, type = 'info') {
            ...
            toast.className = `alert alert-${type} fixed bottom-4 right-4 w-auto max-w-md shadow-lg z-50`;
            toast.innerHTML = `
